...
class LogsCallback
{
    ...
    public static function getLogs($where = null, $order = null, $limit = null, $fields = '*', $group = null)
    {
        return (new Database('logs_callback'))->select($where, $order, $limit, $fields, $group);
    }
    ...
    {
        return self::getLogs('status = "' . $status . '"');
    }
